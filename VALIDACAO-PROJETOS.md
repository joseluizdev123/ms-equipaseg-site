...
Até 767px as letras seguem a escala de celular do site atual (bloco do fim do `main.css`, parte comum, 14/09/2026): o título do hero fica com 32px, em 2 linhas em 767 e 479px e em 3 linhas em 390px, e a página tem 7287px em 390px (254px a menos). Abaixo de 480px vale também a regra do `main.css` presa a `.hero-produto--projetos`, `min(32px, (100vw - 48px) / 8.5)`, que só reduz a fonte abaixo de 320px, para "Desenvolvimento" caber. O `projetos.css` não declara mais tamanho de fonte: ficou só a entrelinha proporcional (`line-height: 1.33`).
